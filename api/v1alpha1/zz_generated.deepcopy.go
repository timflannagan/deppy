...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamedProperty) DeepCopyInto(out *NamedProperty) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamedProperty.
func (in *NamedProperty) DeepCopy() *NamedProperty {
	if in == nil {
		return nil
	}
	out := new(NamedProperty)
	in.DeepCopyInto(out)
	return out
}
